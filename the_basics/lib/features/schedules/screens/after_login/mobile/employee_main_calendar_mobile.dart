...
import 'package:the_basics/features/schedules/screens/after_login/web/main_calendar/utils/appointment_builder_employee.dart';
...
class EmployeeMainCalendarMobile extends StatefulWidget {
  ...
  @override
  State<EmployeeMainCalendarMobile> createState() => _EmployeeMainCalendarMobileState();
}

class _EmployeeMainCalendarMobileState extends State<EmployeeMainCalendarMobile> {
  ...
  List<Appointment> _getAppointments(String userID) {
    ...
    for (final leave in userLeaves) {
      ...
      final visualEndDateTime = leave.startDate.isAtSameMomentAs(leave.endDate)
          ? startDateTime.add(const Duration(hours: 8))
          : endDateTime;
